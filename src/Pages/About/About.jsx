...
const About = () => {
  return (
    <div className="pt-40 md:pt-20 min-h-[100vh]">
      <Helmet><title>LUXURY | ABOUT</title></Helmet>
            ...
            <div className="mb-56">
              <div className="flex flex-col md:flex-row gap-10">
                ...
                <div className=" ">
                  <h1 data-aos="fade-up"
            data-aos-duration="1000"
            data-aos-delay="700" className="text-4xl md:text-6xl font-bold font-gilda mb-7 text-white">
                    Your peace of mind, our priority
                  </h1>
                  <p data-aos="fade-up"
            data-aos-duration="1000"
            data-aos-delay="900" className="leading-8 text-lg font-bold text-justify">
            ...
            <div>
                <div className="flex flex-col md:flex-row-reverse justify-between gap-10">
                    <div>
                        ...
                        data-aos-duration="1000"
                        data-aos-delay="1100"
                         src={'https://i.ibb.co/crc52y5/Group-45.png'} alt="" className="md:max-w-[500px]" />
                    </div>
                    <div className=" ">
                  <h1
                  data-aos="fade-up"
                  ...
                  data-aos="fade-up"
                  data-aos-duration="1000"
                  data-aos-delay="1500" className="leading-8 text-lg font-bold max-w-[530px] text-justify text-gray-900">
                  ...
                  data-aos="fade-up"
                  data-aos-duration="1000"
                  data-aos-delay="1700" className="md:text-center mb-20 text-2xl rounded-xl mt-7 px-4 py-6 bg-[#DFE3E7]">We strive to offer you best possible homes to stay.  </p>
                </div>
                </div>
            </div>
          </div>
